...
class Search {
  ...
  constructor(){
    ...
    this.openSearch = jQuery('#header-hex-search');
      ...
      if (results.postsPages.length){
        this.resultsDiv.html(`<div id="search-results-inner">
          ...
          <a href="${item.permalink}" class="search-result">
            ...
            <svg viewBox="0 0 42 42" class="post-comments">
              <path class="post-comments-icon" d="M36.7,0H5.3C2.4,0,0,2.4,0,5.3v21c0,2.9,2,5.3,5,5.3V42l10.8-10h21c2.9,0,5.3-2.9,5.3-5.8v-21C41.9,2.4,39.5,0,36.7,0z"/>
            </svg>
            <span class="search-result-comment-count">${item.commentCount}</span>
            <svg viewBox="0 0 42 42" class="post-likes">
              <path class="post-likes-icon" d="M38.4,23L38.4,23c4.8-5.2,4.8-13.8,0-19l0,0c-4.8-5.2-12.6-5.2-17.4,0c-4.8-5.2-12.6-5.2-17.4,0l0,0c-4.8,5.2-4.8,13.8,0,19l0,0l0,0L21,42L38.4,23L38.4,23z"/>
            </svg>
            <span class="search-result-like-count">${item.likeCount}</span>
          </a>
          `).join('')}</div>`);
        jQuery('a.search-result').height(jQuery('.search-result').width());
      } else {
